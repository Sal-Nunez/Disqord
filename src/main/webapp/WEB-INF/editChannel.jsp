...
<meta charset="UTF-8">
	...
	<title>Edit ${thisChannel.name} Channel</title>
</head>
<body class="bg-dark mt-5 container d-flex justify-content-center" style="color: whitesmoke;">
<div class="container d-flex justify-content-center flex-column">
	<div>
	    <h1>Editing ${thisChannel.name} Channel</h1>
	    <a href="/dashboard" class="mt-2 btn btn-primary">Back to Dashboard</a>
	    
	    <form:form class="" action="/servers/${server.id}/channels/${thisChannel.id}/update" method="post" modelAttribute="channel">
	        <form:input type="hidden" path="server" value="${server.id }"/>
	        <form:input type="hidden" path="id" value="${thisChannel.id }"/>
	        <div class="form-group">
	            <label>Channel Name:</label>
	            <form:input path="name" class="form-control mb-3" value="${thisChannel.name}"/>
